            ...
            <div className="flex-col">
              ...
              <div className="flex flex-wrap">
                ...
                <p className="text-xs font-sans text-left pl-10 pt-10 w-1/2">
                  <FontAwesomeIcon icon={faCircleCheck} size={"1x"} /> Provide
                  amazing user experiences by leveraging the power of JavaScript
                  with ease
                </p>

                <p className="text-xs font-sans pl-10 pt-10 w-1/2">
                  <FontAwesomeIcon icon={faCircleCheck} size={"1x"} /> Learn all
                  about React Hooks and React Components
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-col h-full bg-white shadow-2xl">
            ...
            <div className="flex-col">
              ...
              <div className="flex-col mt-4 bg-white">
                ...
                <div className="flex justify-center">
                  <button className="text-sky-400 p-3">Start Learning</button>
                </div>
              </div>
            </div>
          </div>
